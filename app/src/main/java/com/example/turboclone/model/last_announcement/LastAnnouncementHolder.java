...
public class LastAnnouncementHolder extends RecyclerView.ViewHolder {
    public ImageView carImage;
    public TextView carPrice, carModel, carInformation, carDate, carSalon;

    public LastAnnouncementHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bindData(LastAnnouncementModel item, int position) {
